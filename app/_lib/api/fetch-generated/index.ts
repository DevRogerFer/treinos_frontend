 ...
 * API para gerenciamento de treinos do Bootcamp
...
export type CompleteWorkoutSession422 = {
  error: string;
  code: string;
};
...
export type completeWorkoutSessionResponse422 = {
  data: CompleteWorkoutSession422;
  status: 422;
};
...
export type completeWorkoutSessionResponseError = (
  ...
  | completeWorkoutSessionResponse422
...
/**
 * @summary Get workout statistics for a period
 */
